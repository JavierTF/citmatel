...
class area_form(ModelForm):
    centro_costo = forms.CharField(label = 'Centro de costo', max_length = 65, required = False, 
...
class indicador_objetivo_form(ModelForm):
    ...
    nombre = forms.CharField(label = 'Nombre*', max_length = 250, required = True, widget = widgets.Textarea(
                attrs={'class': 'form-control', 'autocomplete': 'on', 'placeholder': 'Introduzca el nombre'}))
