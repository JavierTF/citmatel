...
class area(models.Model):
     ...
     centro_costo = models.CharField(max_length = 10, verbose_name = "centro de costo*", blank = True, null = True)
     activo = models.BooleanField(default = True, verbose_name = "activo*")
...
class acuerdo(models.Model):
    numero = models.CharField(max_length = 6, verbose_name = "Número de acuerdo*", null = True, blank = True)
    nombre = models.CharField(max_length = 125, verbose_name = 'Nombre del acuerdo*', null = True, blank = True)
