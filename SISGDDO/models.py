...
class Afectaciones(models.Model):
        ...
        estado=models.ForeignKey(estados, on_delete = models.SET('Estado eliminado de la Base de datos'),
                                   related_name = 'Estado', verbose_name = 'Estado',
                                   null = True) 
        activo=models.BooleanField(auto_created=True,verbose_name='Activo',default=True)
...
class incidencia(models.Model):
    ...
    ejecutante = models.ManyToManyField(
        area,
        verbose_name=("Ejecutor"),
        blank=True,
    )
    respuesta = models.TextField(max_length = 1000, verbose_name = 'Seguimiento',blank= True, default='')
    observacion=models.CharField(max_length=250,verbose_name='Seguimiento agregado',default='',blank=True)
    estado=models.ForeignKey(estados, on_delete = models.SET('Estado eliminado de la Base de datos'),
                                   related_name = 'Estadoincidencia', verbose_name = 'Estado',
