...
# #     path('exportar/proyecto/<int:id>/', views_sisgddo.exportar_proyecto, name= "exportar_proyecto"),
 ...
 #Probar LDAP
    ...
    path('check_name_uniqueness', views_sisgddo.check_name_uniqueness, name='check_name_uniqueness'),
    ...
    path('listar/estados', views_sisgddo.listar_estados, name = "listar_estados"),
    path('adicionar/estado', views_sisgddo.agregar_estado, name = "agregar_estado"),
    path('modificar/estado/<int:id>', views_sisgddo.modificar_estado, name="modificar_estado"),
    path('eliminar/estado/<int:id>/', views_sisgddo.eliminar_estado, name="eliminar_estado"),
